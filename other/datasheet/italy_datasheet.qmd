---
title: "Determinants of Soccer Players' Market Values - Italy"
author: John Zhang
...
1. **For what purpose was the dataset created?**  
   To analyze determinants of soccer players’ market values, focusing on the Serie A. The goal is to enable robust insights for scouting, player valuation, and transfer market analysis.
...
1. **What do the instances that comprise the dataset represent?**  
   Each instance represents a Serie A player and their associated attributes, including market value, performance metrics, and contextual variables.

2. **How many instances are there in total?**  
   The dataset contains 441 player records.

3. **Is the dataset a sample or does it contain all possible instances?**  
   The dataset is a comprehensive sample of Serie A players for the 2023/24 season.
...
3. **What was the sampling strategy?**  
   Players were sampled based on their inclusion in the Serie A for the 2023/24 season.
...
5. **Over what timeframe was the data collected?**  
   Data was collected during and after the 2023/24 Serie A season.
