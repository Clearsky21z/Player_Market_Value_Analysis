...
generate_unique_player_names <- function(n, country) {
  name_pool <- list(
    "England" = list(
      first_names = c(
        "James", "John", "William", "George", "Henry", "Edward", "Arthur",
      ...
      last_names = c(
        "Smith", "Jones", "Taylor", "Brown", "Williams", "Wilson", "Evans",
    ...
    "France" = list(
      first_names = c(
        "Jean", "Pierre", "Michel", "Claude", "Jacques", "Philippe",
      ...
      last_names = c(
        "Dubois", "Durand", "Lefebvre", "Moreau", "Laurent", "Simon",
    ...
    "Germany" = list(
      first_names = c(
        "Hans", "Karl", "Heinrich", "Otto", "Wolfgang", "Jürgen",
    ...
    "Italy" = list(
      first_names = c(
        "Giuseppe", "Mario", "Luca", "Antonio", "Francesco", "Paolo",
    ...
    "Spain" = list(
      first_names = c(
        "José", "Manuel", "Antonio", "Juan", "Francisco", "Carlos",
