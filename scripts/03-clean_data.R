...
# England
clean_data(
  "data/01-raw_data/raw_market_value_data/raw_england_market_value_data.csv",
...
# Germany
clean_data(
  "data/01-raw_data/raw_market_value_data/raw_germany_market_value_data.csv",
...
# Italy
clean_data(
  "data/01-raw_data/raw_market_value_data/raw_italy_market_value_data.csv",
...
# Spain
clean_data(
  "data/01-raw_data/raw_market_value_data/raw_spain_market_value_data.csv",
...
# France
clean_data(
  "data/01-raw_data/raw_market_value_data/raw_france_market_value_data.csv",
